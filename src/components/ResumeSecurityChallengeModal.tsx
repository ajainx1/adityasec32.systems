      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-emerald-500/20 px-5 py-4 sm:px-6 shrink-0 bg-slate-900/95 backdrop-blur-md">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-[10px] sm:text-[11px] font-mono font-bold text-emerald-400 tracking-wider flex items-center gap-2">
                <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
                <span>SECOPS CLEARANCE GATEWAY // LEVEL 4</span>
              </div>
              <h2 className="text-sm sm:text-base font-bold font-title text-white">
        ...
        <div className="p-4 sm:p-6 overflow-y-auto flex-1 space-y-4 sm:space-y-5">
          ...
          {isUnlocked ? (
            ...
            >
              <div className="w-16 h-16 sm:w-20 sm:h-20 mx-auto rounded-full bg-emerald-500/20 border-2 border-emerald-400 flex items-center justify-center text-emerald-400 shadow-[0_0_30px_rgba(16,185,129,0.5)]">
                <Unlock className="w-8 h-8 sm:w-10 sm:h-10 animate-bounce" />
              </div>

              <div className="space-y-2">
                <h3 className="text-xl sm:text-2xl font-black font-title text-emerald-400">
            ...
            <>
              ...
              <div className="space-y-1.5">
                ...
                {/* Progress Bar */}
                <div className="w-full h-2 rounded-full bg-slate-950 border border-emerald-500/30 overflow-hidden p-0.5 shadow-inner">
                  <motion.div
              ...
              {/* Question Card */}
              <div className="p-4 sm:p-5 rounded-2xl bg-slate-950 border border-slate-800 space-y-3 shadow-md">
                  ...
                  {currentQ.options.map((opt, idx) => {
                    ...
                    return (
                      <button
                        ...
                        disabled={isAnswered}
                        className={`w-full text-left p-3 rounded-xl border text-xs sm:text-sm font-mono transition-all flex items-center justify-between gap-3 cursor-pointer ${optStyle}`}
                      >
                        <div className="flex items-center gap-3">
              ...
              <AnimatePresence>
                {isAnswered && (
                  <motion.div
                    ...
                    className={`p-3.5 sm:p-4 rounded-xl border text-xs leading-relaxed font-mono ${
                      isCorrect 
                        ? "bg-emerald-500/10 border-emerald-500/40 text-emerald-300" 
                        : "bg-rose-500/10 border-rose-500/40 text-rose-300"
                    }`}
                  >
                    <div className="font-bold flex items-center gap-2 mb-1 text-xs sm:text-sm">
                      {isCorrect ? (
                        <>
        ...
        {!isUnlocked && (
          <div className="px-5 py-3.5 sm:px-6 border-t border-slate-800 bg-slate-950/95 backdrop-blur-md shrink-0 flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 text-xs font-mono font-bold text-amber-400 hover:text-amber-300 bg-amber-500/10 hover:bg-amber-500/20 px-3.5 py-2 rounded-xl border border-amber-500/30 transition-all cursor-pointer w-full sm:w-auto justify-center"
              ...
              <div className="flex items-center gap-2 w-full sm:w-auto justify-end">
                {isCorrect ? (
                  <button
                    ...
                    className="px-5 py-2 rounded-xl bg-emerald-500 text-slate-950 font-mono font-bold text-xs hover:bg-emerald-400 transition-all flex items-center gap-2 shadow-md shadow-emerald-500/25 cursor-pointer w-full sm:w-auto justify-center"
                  >
                  ...
                  <button
                    ...
                    className="px-5 py-2 rounded-xl bg-rose-500/20 border border-rose-500/40 text-rose-300 hover:bg-rose-500/30 font-mono font-bold text-xs transition-all flex items-center gap-2 cursor-pointer w-full sm:w-auto justify-center"
                  >
