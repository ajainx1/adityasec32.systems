...
export default function ImpactPageClient() {
  ...
  const AUGUST_FEEDING_DRIVE: ImpactRecord[] = [
    ...
    { src: '/impact/aug-19.jpeg', title: 'Pack Sustenance & Hydration Station', location: 'Kurji, Patna', date: '17 Aug 2026 • 01:10 PM', tag: 'Hydration Aid', description: 'Dual hydration and rice nutrition station setup.' },
