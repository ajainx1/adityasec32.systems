...
const RESCUE_RECORDS: RescueRecord[] = [
  {
    src: '/impact/dog-feed-15.jpeg',
    titleEn: 'Bicycle Stand Alley Feeding & Care',
    titleHi: 'साइकिल स्टैंड के पास बेसहारा श्वान को पौष्टिक भोजन',
    location: 'Rajbansi Nagar Division, Patna, Bihar',
    date: '06 Sep 2026 • 01:25 PM IST',
    tagEn: '🍲 Fresh Nutritious Lunch',
    tagHi: '🍲 ताजा दोपहर का भोजन',
    tagColor: 'bg-emerald-500/20 text-emerald-300 border-emerald-500/40',
    category: 'feeding',
    patientName: 'Kalu (Community Dog)',
    urgencyEn: 'Weakened from rain and hunger; fed warm egg and rice directly in a clean feeding bowl.',
    urgencyHi: 'कमजोरी और भूख से बेहाल श्वान को स्वच्छ पात्र में ताजा अंडा और चावल परोसा गया।',
    storyEn: 'Found resting under a bicycle frame searching for food scraps. We served a large portion of freshly cooked boiled rice and protein mash to restore his stamina.',
    storyHi: 'साइकिल के नीचे भूखा बैठा था। उसे तुरंत ताजा पकाया हुआ गर्म चावल और प्रोटीन युक्त आहार दिया गया जिससे उसकी ऊर्जा लौट सके।'
  },
  {
    src: '/impact/dog-feed-16.jpeg',
    titleEn: 'Night Market Emergency Broth & Nutrition',
    titleHi: 'रात्रि बाजार में भूखे श्वान को पौष्टिक दूध व शोरबा',
    location: 'Boring Road Market Stall, Patna, Bihar',
    date: '05 Sep 2026 • 09:15 PM IST',
    tagEn: '🌙 Night Hunger Relief',
    tagHi: '🌙 रात्रि भूख निवारण',
    tagColor: 'bg-cyan-500/20 text-cyan-300 border-cyan-500/40',
    category: 'feeding',
    patientName: 'Shadow',
    urgencyEn: 'Stalls closed for the night; provided immediate hydration and warm milk broth.',
    urgencyHi: 'दुकानें बंद होने के बाद खाने की तलाश में था; तुरंत ताजा गर्म शोरबा और पोषण दिया गया।',
    storyEn: 'After street market stalls closed, this stray was scavenging empty wrappers. We provided a dedicated bowl of fresh warm broth to safely nourish him through the night.',
    storyHi: 'दुकानें बंद होने के बाद यह खाली डिब्बों में खाना ढूंढ रहा था। इसे रात के समय स्वच्छ पौष्टिक शोरबा दिया गया।'
  },
  {
    src: '/impact/dog-feed-17.jpeg',
    titleEn: 'Monsoon Hydration & Calcium Support',
    titleHi: 'बरसात में स्वच्छ जल व कैल्शियम युक्त आहार',
    location: 'Railway Perimeter, Patna, Bihar',
    date: '05 Sep 2026 • 08:40 PM IST',
    tagEn: '💧 Clean Hydration Drive',
    tagHi: '💧 शुद्ध जल व पोषण',
    tagColor: 'bg-blue-500/20 text-blue-300 border-blue-500/40',
    category: 'feeding',
    patientName: 'Bhura',
    urgencyEn: 'Street puddles carried sewage contamination; offered fresh clean water and electrolyte broth.',
    urgencyHi: 'गंदा पानी पीने से रोकने के लिए स्वच्छ कटोरी में सुरक्षित पानी व दलिया दिया गया।',
    storyEn: 'Stray dogs in Patna often suffer kidney and digestive failures drinking toxic monsoon runoff. We provided safe, clean hydration bowls with calcium broth directly on our evening patrol.',
    storyHi: 'बारिश का दूषित पानी पीने से कई कुत्ते बीमार पड़ जाते हैं। हमारे दल ने तुरंत स्वच्छ जल और पौष्टिक आहार उपलब्ध कराया।'
  },
  {
    src: '/impact/dog-feed-18.jpeg',
    titleEn: 'Severe Malnutrition Intensive Rehabilitation',
    titleHi: 'अत्यधिक कुपोषित श्वान का विशेष देखभाल अभियान',
    location: 'Danapur Division Perimeter, Patna, Bihar',
    date: '04 Sep 2026 • 12:30 PM IST',
    tagEn: '❤️ Critical Nutrition Care',
    tagHi: '❤️ विशेष कुपोषण सुधार',
    tagColor: 'bg-rose-500/20 text-rose-300 border-rose-500/40',
    category: 'medical',
    patientName: 'Shera (Senior Stray)',
    urgencyEn: 'Severely emaciated with protruding ribs; placed on high-calorie soft diet regimen.',
    urgencyHi: 'पसलियां दिखाई दे रही थीं और अत्यधिक कमजोरी थी; उच्च कैलोरी युक्त नरम भोजन शुरू किया गया।',
    storyEn: 'Years of street hardships and territorial fights left this senior dog unable to compete for food. He is now receiving daily dedicated meals of turmeric-infused rice and minced eggs to rebuild muscle and strength.',
    storyHi: 'कमजोरी की वजह से यह दूसरे श्वानों से भोजन नहीं ले पाता था। इसे अब रोजाना हल्दी चावल और उबले अंडे का विशेष आहार दिया जा रहा है।'
  },
  {
    src: '/impact/dog-feed-19.jpeg',
    titleEn: 'Late-Night Alley Patrol & Clean Meal',
    titleHi: 'देर रात गली में स्वच्छ आहार सेवा',
    location: 'Kankarbagh Alleyway, Patna, Bihar',
    date: '03 Sep 2026 • 10:10 PM IST',
    tagEn: '🍲 Midnight Street Patrol',
    tagHi: '🍲 रात्रि गश्ती आहार',
    tagColor: 'bg-amber-500/20 text-amber-300 border-amber-500/40',
    category: 'feeding',
    patientName: 'Tommy',
    urgencyEn: 'Scattered pack member nourished with clean, digest-friendly fresh broth.',
    urgencyHi: 'अकेले घूम रहे श्वान को सुपाच्य और ताजा गर्म भोजन दिया गया।',
    storyEn: 'Responded to community call about stray seeking shelter near brick pillar. Delivered a fresh batch of food so he could sleep full and protected.',
    storyHi: 'ईंटों के खंभे के पास बैठे इस श्वान को गरमा-गरम ताजा भोजन परोसा गया ताकि वह रात में भूखा न रहे।'
  },
  {
